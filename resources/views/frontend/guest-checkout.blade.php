                ...
                <div class="col-lg-8">
                    <div class="quikctech-billing-address">
                        ...
                        <div class="quicktech-form-group">
                            ...
                            <input name="name" type="text" class="form-control quicktech-form-control" placeholder="Name *">
                            @error('name')
                        ...
                        <div class="quicktech-form-group">
                            <input name="phone" type="tel" class="form-control quicktech-form-control" placeholder="Phone *">
                            @error('phone')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="quicktech-order-card card p-4 shadow-sm">
                        ...
                        <table class="quicktech-order-table table">
                            <tbody>
                                <tr>
                                  <td>{{ $course->name }} <span class="text-muted">× 1</span></td>
