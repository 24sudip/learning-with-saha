                ...
                <div class="row">
                    <div class="col-xxl-8 offset-xxl-2 col-xl-8 offset-xl-2">
                        <div class="section__title-wrapper text-center mb-55">
                            <h2 class="section__title bn-font">Password Reset</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="sign__wrapper white-bg">
                            ...
                            <div class="sign__form">
                                <form action="/student/reset-password" method="POST">
                                    ...
                                    <div class="sign__input-wrapper mb-25">
                                        <h5 class="bn-font">Verify Token <small>sent to your phone</small> </h5>
                                        <div class="sign__input">
                                            <input type="text" placeholder="Enter password reset token" name="passresetToken">
