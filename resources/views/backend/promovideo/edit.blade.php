...
@section('title', 'Edit Promo video')
@section('cssLink')
@endsection
@section('cssStyle')
    <style>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" class="form-control" id="buying"
                                                value="{{ $video->title }}" placeholder="Promo video Title" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="link" class="form-control" id="selling"
                                                value="{{ $video->link }}" placeholder="Promo video link" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" name="video" class="form-control" rows="10">{{ $video->video }}</textarea>
                                        </div>
                                    </div>
                                </div>
