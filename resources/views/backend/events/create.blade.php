                        ...
                        <form action="{{ route('admin.events.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="image">Event image<span class="text-danger">* <span style="color:black; color: #00000061; font-size: 12px;"> (780w x 700h)</span></span> </label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="date" class="form-control" placeholder="Discount"
                                                value="{{ old('date') }}" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
